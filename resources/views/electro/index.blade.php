                        ...
                        <div class="js-slide">
                            <div class="row pt-7 py-md-0">
                                ...
                                <div class="col-xl-7 col-6 flex-horizontal-center ml-auto ml-md-0"
                                    data-scs-animation-in="fadeInRight" data-scs-animation-delay="500">
                                    <img class="img-fluid ml-auto mr-10 mr-wd-auto h-100"
                                        src="../../assets/img/416X420/img3.png" alt="Image Description" />
                                </div>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <div class="product-item__body pb-xl-2">
                                                <div class="mb-2">
                                                    <a href="../shop/product-categories-7-column-full-width.html"
                                                        class="font-size-12 text-gray-5">{{ $item->SubCategorie->name }}</a>
                                                </div>
            ...
            <div class="container">
                <div class="row min-height-564 align-items-center">
                    <div class="col-12 col-lg-4 col-xl-5 col-wd-6 d-none d-md-block">
                        <img class="img-fluid" src="{{ $topcategorie->categorie->CategorieImage }}" alt="Image Description" />
                    </div>
                        ...
                        <div class="js-slick-carousel position-static u-slick u-slick--gutters-2 u-slick overflow-hidden u-slick-overflow-visble py-5"
                            ...
                            <div class="js-slide">
                                <ul class="row list-unstyled products-group no-gutters mb-0 overflow-visible">
                                    @foreach ($topcategorie->products as $product)
                                        <li
                                            ...
                                            <div class="product-item__outer h-100 w-100">
                                                <div
                                                    ...
                                                    <div class="col col-lg-auto product-media-left">
                                                        <a href="#" class="max-width-120 d-block"><img
                                                                class="img-fluid" src="{{ $product->FirstImage }}"
                                                                alt="Image Description" /></a>
                                                    </div>
                                                    <div
                                                        ...
                                                        <div class="mb-2">
                                                            <div class="mb-2">
                                                                <a href="../shop/product-categories-7-column-full-width.html"
                                                                    class="font-size-12 text-gray-5">{{ $product->SubCategorie->name }}</a>
                                                            </div>
                                            ...
                                            <div class="product-item__inner p-md-3 row no-gutters bg-white max-width-334">
                                                ...
                                                <div
                                                    ...
                                                    <div class="mb-2">
                                                        <div class="mb-2">
                                                            <a href="../shop/product-categories-7-column-full-width.html"
                                                                class="font-size-12 text-gray-5">Headphones</a>
                                                        </div>
                                                        <h5 class="product-item__title">
                                                            <a href="../shop/single-product-fullwidth.html"
                                            ...
                                            <div class="product-item__inner p-md-3 row no-gutters bg-white max-width-334">
                                                ...
                                                <div
                                                    ...
                                                    <div class="mb-2">
                                                        <div class="mb-2">
                                                            <a href="../shop/product-categories-7-column-full-width.html"
                                                                class="font-size-12 text-gray-5">Accesories</a>
                                                        </div>
                                                        <h5 class="product-item__title">
                                                            <a href="../shop/single-product-fullwidth.html"
                                    ...
                                    <div class="product-item__inner p-md-3 row no-gutters">
                                        ...
                                        <div class="col product-item__body pl-2 pl-lg-3 mr-xl-2 mr-wd-1">
                                            <div class="mb-4 mb-xl-2 mb-wd-6">
                                                ...
                                                <h5 class="product-item__title">
                                                    <a href="../shop/single-product-fullwidth.html"
                                                        class="text-blue font-weight-bold" tabindex="0">White Solo
                                                        2 Wireless</a>
                                                </h5>
                                            </div>
                                            <div class="flex-center-between mb-3">
                    ...
                    <div
                        ...
                        <ul class="nav nav-pills nav-tab-pill mb-2 pt-3 pt-lg-0 mb-0 border-top border-color-1 border-lg-top-0 align-items-center font-size-15 font-size-15-lg flex-nowrap flex-lg-wrap overflow-auto overflow-lg-visble pr-0"
                            ...
                            <li class="nav-item flex-shrink-0 flex-lg-shrink-1">
                                <a class="nav-link rounded-pill active" id="Tpills-one-example1-tab"
                                    data-toggle="pill" href="#Tpills-one-example1" role="tab"
                                    aria-controls="Tpills-one-example1" aria-selected="true">Top 20</a>
                            </li>
                            <li class="nav-item flex-shrink-0 flex-lg-shrink-1">
                        ...
                        <div class="row no-gutters">
                            <div class="col-md-6 col-lg-7 col-wd-8 d-md-flex d-wd-block">
                                <ul class="row list-unstyled products-group no-gutters mb-0">
                                    ...
                                    <li
                                        class="col-md-6 col-lg-4 col-wd-3 product-item d-md-none d-lg-block remove-divider">
                                        <div class="product-item__outer h-100 w-100 w-100 prodcut-box-shadow">
                                            <div class="product-item__inner bg-white p-3">
                                                <div class="product-item__body pb-xl-2">
                                                    <div class="mb-2">
                                    ...
                                    <li
                                        class="col-md-6 col-lg-4 col-wd-3 product-item d-md-none d-wd-block remove-divider">
                                        <div class="product-item__outer h-100 w-100 w-100 prodcut-box-shadow">
                                            <div class="product-item__inner bg-white p-3">
                                                <div class="product-item__body pb-xl-2">
                                                    <div class="mb-2">
                ...
                <div class="position-relative text-center z-index-2 mb-3">
                    <div
                        ...
                        <ul class="nav nav-pills nav-tab-pill mb-2 pt-3 pt-lg-0 mb-0 border-top border-color-1 border-lg-top-0 align-items-center font-size-15 font-size-15-lg flex-nowrap flex-lg-wrap overflow-auto overflow-lg-visble pr-0"
                            ...
                            <li class="nav-item flex-shrink-0 flex-lg-shrink-1">
                                <a class="nav-link rounded-pill active" id="Gpills-one-example1-tab"
                                    data-toggle="pill" href="#Gpills-one-example1" role="tab"
                                    aria-controls="Gpills-one-example1" aria-selected="true">Top 20</a>
                            </li>
                            <li class="nav-item flex-shrink-0 flex-lg-shrink-1">
                ...
                <div class="row align-items-start">
                        ...
                        <div class="row align-items-center align-items-xl-start">
                            ...
                            <div class="col-md-7 pl-lg-0">
                                ...
                                <ul class="mb-1 font-size-13 list-unstyled text-lh-21 d-none d-xl-block">
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">Accessories</a>
                                    </li>
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">Chargers</a>
                                    </li>
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">Powerbanks</a>
                                    </li>
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">Smartphones</a>
                                    </li>
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">Smartwatch</a>
                                    </li>
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">Tablets</a>
                                    </li>
                                </ul>
                                <a href="../shop/product-categories-7-column-full-width.html"
                    ...
                    <div class="col-4 col-wd-3 border-right border-lg-down-0 mb-8">
                        <div class="row align-items-center align-items-xl-start">
                            <div class="col-md-5 mb-3 mb-md-0">
                                <a href="../shop/product-categories-7-column-full-width.html" class="d-block">
                                    <img class="img-fluid" src="../../assets/img/300X300/img2.png"
                                        alt="Image Description" />
                                </a>
                            </div>
                            <div class="col-md-7 pl-lg-0">
                                ...
                                <ul class="mb-1 font-size-13 list-unstyled text-lh-21 d-none d-xl-block">
                                    ...
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">Action Games</a>
                                    </li>
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">Game Consoles</a>
                                    </li>
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">Racing Games</a>
                                    </li>
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">Station Consoles</a>
                                    </li>
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">Video Games & Consoles</a>
                                    </li>
                                </ul>
                                <a href="../shop/product-categories-7-column-full-width.html"
                                    class="d-none d-xl-block text-right font-weight-bold text-gray-15 underline-on-hover">See
                        ...
                        <div class="row align-items-center align-items-xl-start">
                            ...
                            <div class="col-md-7 pl-lg-0">
                                ...
                                <ul class="mb-1 font-size-13 list-unstyled text-lh-21 d-none d-xl-block">
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">Gadgets & Accesories</a>
                                    </li>
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">Smartwatches</a>
                                    </li>
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">Wearables</a>
                                    </li>
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">3D Printing</a>
                                    </li>
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">Alexa Gadgets</a>
                                    </li>
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">Wireless VR Headset</a>
                                    </li>
                                </ul>
                                <a href="../shop/product-categories-7-column-full-width.html"
                                    class="d-none d-xl-block text-right font-weight-bold text-gray-15 underline-on-hover">See
                    ...
                    <div class="col-4 col-wd-3 border-right remove-bd-wd border-lg-down-0 mb-8">
                        <div class="row align-items-center align-items-xl-start">
                            <div class="col-md-5 mb-3 mb-md-0">
                                <a href="../shop/product-categories-7-column-full-width.html" class="d-block">
                                    <img class="img-fluid" src="../../assets/img/300X300/img4.jpg"
                                        alt="Image Description" />
                                </a>
                            </div>
                            <div class="col-md-7 pl-lg-0">
                                ...
                                <ul class="mb-1 font-size-13 list-unstyled text-lh-21 d-none d-xl-block">
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">Blue-ray Players</a>
                                    </li>
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">DVD Players</a>
                                    </li>
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">Home & Audio Entertainment</a>
                                    </li>
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">Home Theater Systems</a>
                                    </li>
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">Soundbar Speakers</a>
                                    </li>
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">Projectors</a>
                                    </li>
                                </ul>
                                <a href="../shop/product-categories-7-column-full-width.html"
                                    class="d-none d-xl-block text-right font-weight-bold text-gray-15 underline-on-hover">See
                        ...
                        <div class="row align-items-center align-items-xl-start">
                            ...
                            <div class="col-md-7 pl-lg-0">
                                ...
                                <ul class="mb-1 font-size-13 list-unstyled text-lh-21 d-none d-xl-block">
                                    ...
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">All in One</a>
                                    </li>
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">Computer Accessories</a>
                                    </li>
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">Computer Monitors</a>
                                    </li>
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">Laptop Skins</a>
                                    </li>
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">Desktop Computers</a>
                                    </li>
                                </ul>
                                <a href="../shop/product-categories-7-column-full-width.html"
                                    class="d-none d-xl-block text-right font-weight-bold text-gray-15 underline-on-hover">See
                        ...
                        <div class="row align-items-center align-items-xl-start">
                            ...
                            <div class="col-md-7 pl-lg-0">
                                ...
                                <ul class="mb-1 font-size-13 list-unstyled text-lh-21 d-none d-xl-block">
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">Cases</a>
                                    </li>
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">Headphone Accessories</a>
                                    </li>
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">Headphone Cases</a>
                                    </li>
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">Headphones</a>
                                    </li>
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">Pendrives</a>
                                    </li>
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">Chargers</a>
                    ...
                    <div class="col-4 col-wd-3 border-right border-lg-down-0 mb-8 d-xl-none d-wd-block">
                        <div class="row align-items-center align-items-xl-start">
                            <div class="col-md-5 mb-3 mb-md-0">
                                <a href="../shop/product-categories-7-column-full-width.html" class="d-block">
                                    <img class="img-fluid" src="../../assets/img/300X300/img7.png"
                                        alt="Image Description" />
                                </a>
                            </div>
                            <div class="col-md-7 pl-lg-0">
                                ...
                                <ul class="mb-1 font-size-13 list-unstyled text-lh-21 d-none d-xl-block">
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">Cameras</a>
                                    </li>
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">Photo Cameras</a>
                                    </li>
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">Video Cameras</a>
                                    </li>
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">GoPro Cameras</a>
                                    </li>
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">Drone Camera</a>
                                    </li>
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">360 camera</a>
                                    </li>
                                </ul>
                                <a href="../shop/product-categories-7-column-full-width.html"
                                    class="d-none d-xl-block text-right font-weight-bold text-gray-15 underline-on-hover">See
                    ...
                    <div class="col-4 col-wd-3 border-lg-down-0 mb-8 d-xl-none d-wd-block">
                        <div class="row align-items-center align-items-xl-start">
                            <div class="col-md-5 mb-3 mb-md-0">
                                <a href="../shop/product-categories-7-column-full-width.html" class="d-block">
                                    <img class="img-fluid" src="../../assets/img/300X300/img8.jpg"
                                        alt="Image Description" />
                                </a>
                            </div>
                            <div class="col-md-7 pl-lg-0">
                                ...
                                <ul class="mb-1 font-size-13 list-unstyled text-lh-21 d-none d-xl-block">
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">Computer Cases</a>
                                    </li>
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">Desktops</a>
                                    </li>
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">Monitors</a>
                                    </li>
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">Software</a>
                                    </li>
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">USB Hubs</a>
                                    </li>
                                    <li>
                                        <a href="../shop/product-categories-7-column-full-width.html"
                                            class="text-gray-15 underline-on-hover">Hard Disk Bags</a>
                                    </li>
                                </ul>
                                <a href="../shop/product-categories-7-column-full-width.html"
                                    class="d-none d-xl-block text-right font-weight-bold text-gray-15 underline-on-hover">See
