                                            ...
                                            <div id="headerSidebarContent"
                                                ...
                                                <a class="d-flex ml-0 navbar-brand u-header__navbar-brand u-header__navbar-brand-vertical"
                                                    ...
                                                    <svg version="1.1" x="0px" y="0px"
                                                        width="175.748px" height="42.52px"
                        ...
                        <div id="navBar" class="collapse navbar-collapse u-header__navbar-collapse">
                            <ul class="navbar-nav u-header__navbar-nav">
                                ...
                                <li class="nav-item hs-has-mega-menu u-header__nav-item" data-event="hover"
                                    ...
                                    <a id="TVMegaMenu" class="nav-link u-header__nav-link u-header__nav-link-toggle"
                                        href="javascript:;" aria-haspopup="true" aria-expanded="false">TV & Audio</a>
                                    ...
                                    <div class="hs-mega-menu w-100 u-header__sub-menu" aria-labelledby="TVMegaMenu">
                                        <div class="row u-header__mega-menu-wrapper">
                                            <div class="col-md-3">
                                                ...
                                                <ul class="u-header__sub-menu-nav-group mb-3">
                                                    <li><a href="#"
                                                            class="nav-link u-header__sub-menu-nav-link">Smart TVs</a>
                                                    </li>
                                                    <li><a href="#"
                                                            class="nav-link u-header__sub-menu-nav-link">4K TVs</a>
                                                    </li>
                                                    <li><a href="#"
                                                            class="nav-link u-header__sub-menu-nav-link">Full HD
                                                            TVs</a></li>
                                                    <li><a href="#"
                                                            class="nav-link u-header__sub-menu-nav-link">Large Screen
                                                            TVs</a></li>
                                                    <li><a href="#"
                                                            class="nav-link u-header__sub-menu-nav-link">32 inch
                                                            TVs</a></li>
                                                    <li><a href="#"
                                                            class="nav-link u-header__sub-menu-nav-link">39-43 inch
                                                            TV</a></li>
                                                    <li><a href="#"
                                                            class="nav-link u-header__sub-menu-nav-link">48 &amp;
                                                            Above</a></li>
                                                </ul>
                                                <span class="u-header__sub-menu-title">Home Audio/Video</span>
                                                <ul class="u-header__sub-menu-nav-group">
                                                    <li><a href="#"
                                                            class="nav-link u-header__sub-menu-nav-link">Speakers</a>
                                                    </li>
                                                    <li><a href="#"
                                                            class="nav-link u-header__sub-menu-nav-link">Home
                                                            Theaters</a></li>
                                                    <li><a href="#"
                                                            class="nav-link u-header__sub-menu-nav-link">Projectors</a>
                                                    </li>
                                                    <li><a href="#"
                                                            class="nav-link u-header__sub-menu-nav-link">Headphones</a>
                                                    </li>
                                                    <li><a href="#"
                                                            class="nav-link u-header__sub-menu-nav-link">Noise
                                                            Cancelling Headphones</a></li>
                                                    <li><a href="#"
                                                            class="nav-link u-header__sub-menu-nav-link">Soundbars</a>
                                                    </li>
                                                    <li><a href="#"
                                                            class="nav-link u-header__sub-menu-nav-link">Headphones
                                                            with Mic</a></li>
                                                </ul>
                                            </div>
                                            <div class="col-md-3">
                                                ...
                                                <ul class="u-header__sub-menu-nav-group mb-3">
                                                    <li><a href="#"
                                                            class="nav-link u-header__sub-menu-nav-link">VU</a></li>
                                                    <li><a href="#"
                                                            class="nav-link u-header__sub-menu-nav-link">Mi LED Smart
                                                            TVs</a></li>
                                                    <li><a href="#"
                                                            class="nav-link u-header__sub-menu-nav-link">Samsung</a>
                                                    </li>
                                                    <li><a href="#"
                                                            class="nav-link u-header__sub-menu-nav-link">Panasonic</a>
                                                    </li>
                                                    <li><a href="#"
                                                            class="nav-link u-header__sub-menu-nav-link">TCL</a></li>
                                                    <li><a href="#"
                                                            class="nav-link u-header__sub-menu-nav-link">Sanyo</a></li>
                                                    <li><a href="#"
                                                            class="nav-link u-header__sub-menu-nav-link">Micromax</a>
                                                    </li>
                                                </ul>
                                                <span class="u-header__sub-menu-title">Shop by Brand</span>
                                                <ul class="u-header__sub-menu-nav-group">
                                                    <li><a href="#"
                                                            class="nav-link u-header__sub-menu-nav-link">JBL</a></li>
                                                    <li><a href="#"
                                                            class="nav-link u-header__sub-menu-nav-link">Sony</a></li>
                                                    <li><a href="#"
                                                            class="nav-link u-header__sub-menu-nav-link">Ultimate
                                                            ears</a></li>
                                                    <li><a href="#"
                                                            class="nav-link u-header__sub-menu-nav-link">Philips</a>
                                                    </li>
                                                    <li><a href="#"
                                                            class="nav-link u-header__sub-menu-nav-link">Protronics</a>
                                                    </li>
                                                    <li><a href="#"
                                                            class="nav-link u-header__sub-menu-nav-link">Saregama</a>
                                                    </li>
                                                    <li><a href="#"
                                                            class="nav-link u-header__sub-menu-nav-link">Harmon
                                                            Kardon</a></li>
                                                </ul>
                                            </div>
                                            <div class="col-md-3">
                                                ...
                                                <ul class="u-header__sub-menu-nav-group mb-3">
                                                    <li><a href="#"
                                                            class="nav-link u-header__sub-menu-nav-link">Home Theater
                                                            Systems</a></li>
                                                    <li><a href="#"
                                                            class="nav-link u-header__sub-menu-nav-link">Projectors
                                                            &amp; Accessoires</a></li>
                                                    <li><a href="#"
                                                            class="nav-link u-header__sub-menu-nav-link">Set top
                                                            Boxes</a></li>
                                                    <li><a href="#"
                                                            class="nav-link u-header__sub-menu-nav-link">Streaming
                                                            Media Players</a></li>
                                                    <li><a href="#"
                                                            class="nav-link u-header__sub-menu-nav-link">DVD &amp;
                                                            Blu-ray Players</a></li>
                                                    <li><a href="#"
                                                            class="nav-link u-header__sub-menu-nav-link">Cables</a>
                                                    </li>
                                                    <li><a href="#"
                                                            class="nav-link u-header__sub-menu-nav-link">Audio-video
                                                            Accessories</a></li>
                                                </ul>
                                                <span class="u-header__sub-menu-title">Shop By Price</span>
                                                <ul class="u-header__sub-menu-nav-group">
                                                    <li><a href="#"
                                                            class="nav-link u-header__sub-menu-nav-link">Below Rs.
                                                            100$</a></li>
                                                    <li><a href="#"
                                                            class="nav-link u-header__sub-menu-nav-link">101$ -
                                                            199$</a></li>
                                                    <li><a href="#"
                                                            class="nav-link u-header__sub-menu-nav-link">200$ -
                                                            299$</a></li>
                                                    <li><a href="#"
                                                            class="nav-link u-header__sub-menu-nav-link">300$ -
                                                            399$</a></li>
                                                    <li><a href="#"
                                                            class="nav-link u-header__sub-menu-nav-link">400$ -
                                                            499$</a></li>
                                                    <li><a href="#"
                                                            class="nav-link u-header__sub-menu-nav-link">500$ -
                                                            599$</a></li>
                                                    <li><a href="#"
                                                            class="nav-link u-header__sub-menu-nav-link">600$ and
                                                            Above</a></li>
                                                </ul>
                                            </div>
                                            <div class="col-md-3">
                                                <a href="#" class="d-block mb-3">
                                                    <img class="img-fluid" src="../../assets/img/300X275/img1.jpg"
                                                        alt="Image Description">
                                                </a>
                                                <a href="#" class="d-block">
                                                    <img class="img-fluid" src="../../assets/img/300X275/img2.jpg"
                                                        alt="Image Description">
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <li class="nav-item hs-has-mega-menu u-header__nav-item" data-event="hover"
                                    data-animation-in="slideInUp" data-animation-out="fadeOut">
                                    <a id="smartphonesMegaMenu"
                                        class="nav-link u-header__nav-link u-header__nav-link-toggle"
                                        href="javascript:;" aria-haspopup="true" aria-expanded="false">Smart
                                        Phones</a>
                                    ...
                                    <div class="hs-mega-menu w-100 u-header__sub-menu"
                                        ...
                                        <div class="row u-header__mega-menu-wrapper">
                                            <div class="col-md-8">
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        ...
                                                        <ul class="u-header__sub-menu-nav-group mb-3">
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Headsets</a>
                                                            </li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Cables
                                                                    &amp; Chargers</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Electronic
                                                                    Accessories</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Selfie
                                                                    Sticks</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Internal
                                                                    Batteries</a></li>
                                                        </ul>
                                                        <span class="u-header__sub-menu-title">Cases &amp;
                                                            Covers</span>
                                                        <ul class="u-header__sub-menu-nav-group">
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">For
                                                                    iPhone X<br> </a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">For
                                                                    Samsung S9</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Below
                                                                    AED 59</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">For
                                                                    Xiaomi</a></li>
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <ul class="u-header__sub-menu-nav-group mb-3">
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">iPads</a>
                                                            </li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Samsung</a>
                                                            </li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Microsoft
                                                                    Surface</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Lenovo</a>
                                                            </li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Innjoo</a>
                                                            </li>
                                                        </ul>
                                                        <ul class="u-header__sub-menu-nav-group">
                                                            <span class="u-header__sub-menu-title">Shop By Price</span>
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <ul class="u-header__sub-menu-nav-group">
                                                            ...
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Mi</a>
                                                            </li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Motorola</a>
                                                            </li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Oppo</a>
                                                            </li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Panasonic<br>
                                                                </a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">HTC</a>
                                                            </li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Blackberry</a>
                                                            </li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">LG</a>
                                                            </li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Micromax</a>
                                                            </li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Nokia</a>
                                                            </li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Huawei</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-md-3">
                                            ...
                                            <div class="col-md-4">
                                                <a href="#" class="d-block">
                                                    <img class="img-fluid" src="../../assets/img/1024X1024/img1.jpg"
                                                        alt="Image Description">
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <li class="nav-item hs-has-mega-menu u-header__nav-item" data-event="hover"
                                    data-animation-in="slideInUp" data-animation-out="fadeOut">
                                    <a id="laptopsdesktopsMegaMenu"
                                        class="nav-link u-header__nav-link u-header__nav-link-toggle"
                                        href="javascript:;" aria-haspopup="true" aria-expanded="false">Laptops &
                                        Desktops</a>

                                    <!-- Laptops & Desktops - Mega Menu -->
                                    <div class="hs-mega-menu w-100 u-header__sub-menu"
                                        aria-labelledby="laptopsdesktopsMegaMenu">
                                        <div class="row u-header__mega-menu-wrapper">
                                            <div class="col-md-8">
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        ...
                                                        <ul class="u-header__sub-menu-nav-group mb-3">
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Thin
                                                                    and Light Laptops</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">2-in-1
                                                                    Laptops</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Gaming
                                                                    Laptops</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Budget
                                                                    Laptops</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Business
                                                                    Laptops</a></li>
                                                        </ul>
                                                        <span class="u-header__sub-menu-title">Shop By Brand</span>
                                                        <ul class="u-header__sub-menu-nav-group">
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Apple<br>
                                                                </a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">HP</a>
                                                            </li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Dell</a>
                                                            </li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Lenovo</a>
                                                            </li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Acer</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-md-3">
                                                        ...
                                                        <ul class="u-header__sub-menu-nav-group mb-3">
                                                            ...
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Apple</a>
                                                            </li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Samsung</a>
                                                            </li>
                                                            ...
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">iBall</a>
                                                            </li>
                                                        </ul>
                                                        ...
                                                        <ul class="u-header__sub-menu-nav-group">
                                                            ...
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Keyboards<br>
                                                                </a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Mice</a>
                                                            </li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Laptop
                                                                    Bags</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">PC
                                                                    Speakers</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Batteries</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-md-3">
                                                        ...
                                                        <ul class="u-header__sub-menu-nav-group mb-3">
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Intel</a>
                                                            </li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">AMD</a>
                                                            </li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Qualcomm</a>
                                                            </li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">IBM</a>
                                                            </li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Motorola</a>
                                                            </li>
                                                        ...
                                                        <ul class="u-header__sub-menu-nav-group">
                                                            ...
                                                            <li><a href="#"
                                                                    ...
                                                                    699$</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">700$ -
                                                                    799$</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">800$ -
                                                                    899$</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">900$
                                                                    and Above</a></li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-md-3">
                                                        ...
                                                        <ul class="u-header__sub-menu-nav-group">
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Intel
                                                                    Core i9-7980XE<br> </a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">AMD
                                                                    Ryzen Threadripper 1950X</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">AMD
                                                                    Ryzen 5 1600X</a></li>
                                                            <li><a href="#"
                                            ...
                                            <div class="col-md-4">
                                                <a href="#" class="d-block">
                                                    <img class="img-fluid" src="../../assets/img/1024X1024/img2.jpg"
                                                        alt="Image Description">
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <li class="nav-item hs-has-mega-menu u-header__nav-item" data-event="hover"
                                    data-animation-in="slideInUp" data-animation-out="fadeOut">
                                    <a id="GadgetsMegaMenu"
                                        class="nav-link u-header__nav-link u-header__nav-link-toggle"
                                        href="javascript:;" aria-haspopup="true" aria-expanded="false">Gadgets</a>

                                    <!-- Gadgets - Mega Menu -->
                                    <div class="hs-mega-menu w-100 u-header__sub-menu"
                                        aria-labelledby="GadgetsMegaMenu">
                                        <div class="row u-header__mega-menu-wrapper">
                                            <div class="col-md-4">
                                                <div class="row">
                                                    <div class="col-md-6 mb-3">
                                                        <a href="#" class="d-block">
                                                            <img class="img-fluid"
                                                                src="../../assets/img/300X275/img3.jpg"
                                                                alt="Image Description">
                                                        </a>
                                                    </div>
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <ul class="u-header__sub-menu-nav-group">
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Laptops,
                                                                    Desktops &amp; Monitors</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Networking
                                                                    &amp; Internet Devices</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Computer
                                                                    Accessories</a></li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <a href="#" class="d-block">
                                                            <img class="img-fluid"
                                                                src="../../assets/img/300X275/img4.jpg"
                                                                alt="Image Description">
                                                        </a>
                                                    </div>
                                                    <div class="col-md-6">
                                                        ...
                                                        <ul class="u-header__sub-menu-nav-group">
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Hard
                                                                    Drives</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Pen
                                                                    Drives & Memory Cards</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Printers
                                                                    & Ink</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Mouse</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="row">
                                                    <div class="col-md-6 mb-3">
                                                        <a href="#" class="d-block">
                                                            <img class="img-fluid"
                                                                src="../../assets/img/300X275/img5.jpg"
                                                                alt="Image Description">
                                                        </a>
                                                    </div>
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <ul class="u-header__sub-menu-nav-group">
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">DSLR</a>
                                                            </li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Lenses</a>
                                                            </li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Security
                                                                    &amp; Surveillance</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Binoculars
                                                                    &amp; Telescopes</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Camcorders</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <a href="#" class="d-block">
                                                            <img class="img-fluid"
                                                                src="../../assets/img/300X275/img6.jpg"
                                                                alt="Image Description">
                                                        </a>
                                                    </div>
                                                    <div class="col-md-6">
                                                        ...
                                                        <ul class="u-header__sub-menu-nav-group">
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Men's
                                                                    Watches</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Women's
                                                                    Watches</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Premium
                                                                    Watches</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Kids
                                                                    Watches</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Deals
                                                                    on Watches</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="row">
                                                    <div class="col-md-6 mb-3">
                                                        <a href="#" class="d-block">
                                                            <img class="img-fluid"
                                                                src="../../assets/img/300X275/img7.jpg"
                                                                alt="Image Description">
                                                        </a>
                                                    </div>
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <ul class="u-header__sub-menu-nav-group">
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Mouses</a>
                                                            </li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Keyboards</a>
                                                            </li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Hardrives</a>
                                                            </li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Headphones</a>
                                                            </li>
                                                    ...
                                                    <div class="col-md-6">
                                                        <a href="#" class="d-block">
                                                            <img class="img-fluid"
                                                                src="../../assets/img/300X275/img8.jpg"
                                                                alt="Image Description">
                                                        </a>
                                                    </div>
                                                    <div class="col-md-6">
                                                        ...
                                                        <ul class="u-header__sub-menu-nav-group">
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Fire
                                                                    TV Stick</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Google
                                                                    Chromecast</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Set
                                                                    Top</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Accessories</a>
                                                            </li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Deals
                                                                    of the Day</a></li>
                                ...
                                <li class="nav-item hs-has-mega-menu u-header__nav-item" data-event="hover"
                                    ...
                                    <a id="GPSCarMegaMenu"
                                        class="nav-link u-header__nav-link u-header__nav-link-toggle"
                                        href="javascript:;" aria-haspopup="true" aria-expanded="false">GPS &
                                        Car</a>

                                    <!-- GPS & Car - Mega Menu -->
                                    <div class="hs-mega-menu w-100 u-header__sub-menu"
                                        aria-labelledby="GPSCarMegaMenu" style="min-width: 330px;">
                                        <div class="row u-header__mega-menu-wrapper">
                                            <div class="col-md-8">
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        ...
                                                        <ul class="u-header__sub-menu-nav-group">
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Music
                                                                    Systems</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Video
                                                                    Systems</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Speakers</a>
                                                            </li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Car
                                                                    Monitors</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Car
                                                                    Parts</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Monitoring</a>
                                                            </li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Network
                                                                    Jammers</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Car
                                                                    Accessories</a></li>
                                                            <li><a href="#"
                                                                    ...
                                                                    Electronics</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">All
                                                                    Audio Products</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Accessories</a>
                                                            </li>
                                                    ...
                                                    <div class="col-md-3">
                                                        <span class="u-header__sub-menu-title">GPS &
                                                            Accessories</span>
                                                        <ul class="u-header__sub-menu-nav-group">
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Gps
                                                                    Tracking Devices</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">GPS
                                                                    Networking Devices</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">GPS
                                                                    Tracking Sensors</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">GPS
                                                                    Monitoring</a></li>
                                                            <li><a href="#"
                                                    ...
                                                    <div class="col-md-3">
                                                        <span class="u-header__sub-menu-title">Accessories &amp;
                                                            Parts</span>
                                                        <ul class="u-header__sub-menu-nav-group mb-3">
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Car
                                            ...
                                            <div class="col-md-4">
                                                <a href="#" class="d-block">
                                                    <img class="img-fluid" src="../../assets/img/1024X1024/img3.jpg"
                                                        alt="Image Description">
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <li class="nav-item hs-has-mega-menu u-header__nav-item" data-event="hover"
                                    data-animation-in="slideInUp" data-animation-out="fadeOut">
                                    <a id="CamerasAccessoriesMegaMenu"
                                        class="nav-link u-header__nav-link u-header__nav-link-toggle"
                                        href="javascript:;" aria-haspopup="true" aria-expanded="false">Cameras &
                                        Accessories</a>

                                    <!-- Cameras & Accessories - Mega Menu -->
                                    <div class="hs-mega-menu w-100 u-header__sub-menu"
                                        aria-labelledby="CamerasAccessoriesMegaMenu">
                                        <div class="row u-header__mega-menu-wrapper">
                                            <div class="col-md-8">
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        ...
                                                        <ul class="u-header__sub-menu-nav-group mb-3">
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">DSLR
                                                                    Cameras</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Digital
                                                                    Cameras</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Security
                                                                    &amp; Surveillance</a></li>
                                                            ...
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Consoles</a>
                                                            </li>
                                                        </ul>
                                                        <span class="u-header__sub-menu-title">Shop By Price</span>
                                                        <ul class="u-header__sub-menu-nav-group">
                                                    ...
                                                    <div class="col-md-3">
                                                        <span class="u-header__sub-menu-title">Shop By Focal
                                                            Length</span>
                                                        <ul class="u-header__sub-menu-nav-group mb-3">
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">8mm -
                                                                    24mm</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">24mm
                                                                    - 35mm</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">35mm
                                                                    - 85mm</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">85mm
                                                                    - 135mm</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">135mm+</a>
                                                            </li>
                                                        </ul>
                                                        <span class="u-header__sub-menu-title">#Trending</span>
                                                        <ul class="u-header__sub-menu-nav-group">
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Sony</a>
                                                            </li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Nikon</a>
                                                            </li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Canon</a>
                                                            </li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Sanyo</a>
                                                            </li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Samsung</a>
                                                            </li>
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <ul class="u-header__sub-menu-nav-group">
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Data
                                                                    Cables</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Keypads</a>
                                                            </li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Earphones</a>
                                                            </li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Lenses</a>
                                                            </li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Camera
                                                                    Accessories</a></li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-md-3">
                                                        ...
                                                        <ul class="u-header__sub-menu-nav-group">
                                                            ...
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Pentax</a>
                                                            </li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Sony</a>
                                                            </li>
                                                            ...
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Leica</a>
                                                            </li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Samsung</a>
                                                            </li>
                                                            ...
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Olympus</a>
                                                            </li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Sanyo</a>
                                                            </li>
                                            ...
                                            <div class="col-md-4">
                                                <a href="#" class="d-block">
                                                    <img class="img-fluid" src="../../assets/img/1024X1024/img4.png"
                                                        alt="Image Description">
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <li class="nav-item hs-has-mega-menu u-header__nav-item" data-event="hover"
                                    data-animation-in="slideInUp" data-animation-out="fadeOut">
                                    <a id="MoviesGamesMegaMenu"
                                        class="nav-link u-header__nav-link u-header__nav-link-toggle"
                                        href="javascript:;" aria-haspopup="true" aria-expanded="false">Movies &
                                        Games</a>

                                    <!-- Movies & Games - Mega Menu -->
                                    <div class="hs-mega-menu w-100 u-header__sub-menu"
                                        aria-labelledby="MoviesGamesMegaMenu">
                                        <div class="row u-header__mega-menu-wrapper">
                                            <div class="col-md-4">
                                                <div class="row">
                                                    <div class="col">
                                                        <a href="#" class="d-block">
                                                            <img class="img-fluid"
                                                                src="../../assets/img/300X275/img9.jpg"
                                                                alt="Image Description">
                                                        </a>
                                                    </div>
                                                    <div class="col">
                                                        ...
                                                        <ul class="u-header__sub-menu-nav-group">
                                                            ...
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Blu-ray</a>
                                                            </li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Latest
                                                                    Movies</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">All
                                                                    English</a></li>
                                            ...
                                            <div class="col-md-4">
                                                <div class="row">
                                                    <div class="col">
                                                        <a href="#" class="d-block">
                                                            <img class="img-fluid"
                                                                src="../../assets/img/300X275/img10.jpg"
                                                                alt="Image Description">
                                                        </a>
                                                    </div>
                                                    <div class="col">
                                                        ...
                                                        <ul class="u-header__sub-menu-nav-group">
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Games
                                                                    &amp; Accessories</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">PC
                                                                    Games</a></li>
                                            ...
                                            <div class="col-md-4">
                                                <div class="row">
                                                    <div class="col">
                                                        <a href="#" class="d-block">
                                                            <img class="img-fluid"
                                                                src="../../assets/img/300X275/img11.jpg"
                                                                alt="Image Description">
                                                        </a>
                                                    </div>
                                                    <div class="col">
                                                        ...
                                                        <ul class="u-header__sub-menu-nav-group">
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">5.1
                                                                    Speaker</a></li>
                                                            <li><a href="#"
                                                                    class="nav-link u-header__sub-menu-nav-link">Home
                                                                    Theatres</a></li>
