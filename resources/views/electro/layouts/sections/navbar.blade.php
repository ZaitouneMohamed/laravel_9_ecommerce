                    ...
                    <nav
                        ...
                        <div id="navBar" class="collapse navbar-collapse u-header__navbar-collapse">
                            <ul class="navbar-nav u-header__navbar-nav">
                                ...
                                @foreach (\App\Models\Categorie::all() as $item)
                                    @php
                                        $categorie_image = $item->CategorieImage;
                                    @endphp
                                    <!-- TV & Audio -->
                                            ...
                                            <div class="row u-header__mega-menu-wrapper">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <ul class="u-header__sub-menu-nav-group mb-3">
                                                            @foreach ($item->products as $item)
                                                                <li><a href="#"
                                                                        class="nav-link u-header__sub-menu-nav-link">{{ $item->title }}</a>
                                                                </li>
                                                            @endforeach
                                                        </ul>
                                                    </div>
                                                ...
                                                <div class="col-md-3">
                                                    <a href="#" class="d-block mb-3">
                                                        <img class="img-fluid" src="@php echo $categorie_image @endphp"
                                                            alt="">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- End TV & Audio - Mega Menu {{ $item->CategorieImage }}-->
                                    </li>
                                    <!-- End Pages -->
                                @endforeach
