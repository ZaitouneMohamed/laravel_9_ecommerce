                                    ...
                                    <tr class="delete-product">
                                        ...
                                        <td>
                                            <div class="action-wrapper">
                                                ...
                                                <button
                                                    class="button button-outline-secondary fas fa-trash" onclick="deleteProduct({{$item['id']}})"></button>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
                                ...
                                @foreach (session('cart') as $id => $item)
                                    ...
                                    <tr class="" rowId="{{ $id }}">
                                        <td class="text-center">
                                            <a class="text-gray-32 font-size-26 delete-product">×</a>
                                        </td>
                                        <td class="d-none d-md-table-cell">
                                            <a href="#"><img
                                                    class="img-fluid max-width-100 p-1 border border-color-1"
                                                    src="{{ $item['image'] }}" alt="Image Description"></a>
                                        </td>
                                        <td data-title="Product">
                                            <a href="#" class="text-gray-90">{{ $item['title'] }}</a>
                                        </td>
                                        <td data-title="Price">
